...
wins_per_driver = (
    winners
    .groupby('driverId')          # grupujemy po driverId
...
plt.barh(top_10_winners_plt['full_name'], top_10_winners_plt['wins'], color='skyblue')
plt.xlabel('Kierowca')
plt.ylabel('Liczba zwycięstw')
plt.title('Top 10 kierowców według liczby zwycięstw')
...
fig = px.bar(
    ...
    x='full_name',
    y='wins',
    title='Top 10 kierowców według liczby zwycięstw',
