...
team_colors = {
    "Mercedes": "#00D2BE",  # morski turkus (Mercedes AMG)
    "Red Bull": "#000080",  # intensywny niebieski Red Bulla
    "McLaren": "#FF8700",  # pomarańczowy McLarena
    "Ferrari": "#DC0000",  # czerwony Ferrari
    "Alpine F1 Team": "#F363B9",  # niebieski Alpine
    "Aston Martin": "#0C8040",  # zielony Aston Martin
    "Williams": "#005AFF",  # niebieski Williamsa
    "AlphaTauri": "#4B4B4B",  # szary AlphaTauri
    "Alfa Romeo": "#900000",  # bordowy Alfa Romeo
    "Haas F1 Team": "#F9F2F2",  # szary Haas
}
...
colors = avg_sorted["name"].map(team_colors).fillna("gray")  # nieznane zespoły na szaro
